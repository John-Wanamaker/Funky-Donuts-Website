...
functions all which are defined below
*/
...
for the items purchased in the currect order being checked out.
*/
...
/*getExistingOrder()
Get and return the purchased items in the order being checked out.
*/
...
/*displayReceiptHeader()
Display user information and date, as well as column
headers for te table of purchased items
*/
...
Display total amount of purchase and addition
...
function displayReceiptFooter($grandTotal) {
    ...
    "<tr>
        ...
        <td colspan = '5'>
            ...
            <br>Thank you very much for shopping with Funky Donuts.
...
/*reduceInventory()
Reduce database Inventory level of product purchased by amount purchased.
*/
